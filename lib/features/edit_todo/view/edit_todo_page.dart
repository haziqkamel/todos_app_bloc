...
import 'package:todos_app/features/edit_todo/bloc/edit_todo_bloc.dart';
...
class _TitleField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return TextFormField(
      ...
      onChanged: (title) =>
          context.read<EditTodoBloc>().add(EditTodoTitleChanged(title)),
    );
  }
}
  ...
  Widget build(BuildContext context) {
    ...
    return TextFormField(
      ...
      onChanged: (description) => context
          .read<EditTodoBloc>()
          .add(EditTodoDescriptionChanged(description)),
    );
  }
}
